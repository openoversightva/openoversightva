...
class BaseConfig():
    def __init__(self):
        ...
        # OOVA - AWS face recog
        self.FACE_ACCESS_KEY_ID = os.environ.get("FACE_ACCESS_KEY_ID")
        self.FACE_SECRET_ACCESS_KEY = os.environ.get("FACE_SECRET_ACCESS_KEY")
        self.FACE_COLLECTION_NAME = os.environ.get("FACE_COLLECTION_NAME")

        # Upload Settings
        self.ALLOWED_EXTENSIONS = {"jpeg", "jpg", "jpe", "png", "gif", "webp"}
        self.ALLOWED_DOC_EXTENSIONS = {'jpeg', 'jpg', 'jpe', 'png', 'gif', 'webp',
            'pdf', 'doc', 'docx', 'xls', 'xlxs', 'ppt', 'pptx'}
        self.MAX_CONTENT_LENGTH = 500 * MEGABYTE
